...
def process(job_description, files):
    ...
    try:
        ...
        try:
            ...
            log.append("TF-IDF failed → using zeros")
        ...
        try:
            ...
            log.append("SBERT failed → using zeros")
        ...
        try:
            ...
            log.append(f"BM25 scoring failed → using zeros. Error: {e}")
        ...
        try:
            ...
            log.append("Cross-Encoder failed → using zeros")
        ...
        try:
            ...
            log.append(f"Fuzzy score failed → using random. Error: {e}")
...
with gr.Blocks(title="AI Resume Ranker") as app:
    ...
    gr.Markdown("## Upload resumes → extract skills → rank candidates → interview → download report")
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("📐 Model Scores"):
            out_scores = gr.Dataframe(label="Model Score Breakdown")

        with gr.TabItem("🧩 Extracted Skills"):
        ...
        # INTERVIEW MODULE
        # ============================================================
        with gr.TabItem("🗣️ Interview Module"):
